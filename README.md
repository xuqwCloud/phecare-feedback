...
PheCare 是一款面向 PKU 宝宝家长与照护者的 iPhone 日常记录工具。它帮助用户整理每日食物、特殊配方、血 Phe 检验结果及成长数据，并在设备本地完成换算和趋势展示。
...
> **重要说明**
>
> PheCare 是家庭日常记录、数值换算与信息整理工具，不提供个体状态判断、方案制定、适用性判断或特殊配方用量建议。App 内目标由用户根据自己确认的管理依据填写，参考区间和估算结果不会自动生成个体化结论或行动建议。
